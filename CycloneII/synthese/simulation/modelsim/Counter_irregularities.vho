...
-- KEY_0	=>  Location: PIN_G26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- GPIO_0_0	=>  Location: PIN_D25,	 I/O Standard: 2.5 V,	 Current Strength: 8mA
-- GPIO_0_1	=>  Location: PIN_AE21,	 I/O Standard: 2.5 V,	 Current Strength: 16mA
...
-- Equation(s):
-- \inst_counter|cnt[1]~7_combout\ = (\inst_counter|cnt\(1) & (\inst_counter|cnt\(0) $ (VCC))) # (!\inst_counter|cnt\(1) & (\inst_counter|cnt\(0) & VCC))
-- \inst_counter|cnt[1]~8\ = CARRY((\inst_counter|cnt\(1) & \inst_counter|cnt\(0)))
...
-- Equation(s):
-- \inst_counter|cnt[7]~19_combout\ = \inst_counter|cnt[6]~18\ $ (!\inst_counter|cnt\(7))
...
-- Equation(s):
-- \inst_counter|Equal0~1_combout\ = (\inst_counter|cnt\(4) & (!\inst_counter|cnt\(5) & (!\inst_counter|cnt\(6) & \inst_counter|cnt\(7))))
...
-- Equation(s):
-- \inst_counter|Equal0~2_combout\ = (\inst_counter|Equal0~0_combout\ & \inst_counter|Equal0~1_combout\)
...
-- pragma translate_on
PORT MAP (
	datab => \inst_counter|Equal0~0_combout\,
