...
-- Equation(s):
-- \inst_counter|Equal0~1_combout\ = (!\inst_counter|cnt\(6) & (!\inst_counter|cnt\(5) & (\inst_counter|cnt\(7) & \inst_counter|cnt\(4))))
...
-- Equation(s):
-- \inst_counter|Equal0~0_combout\ = (!\inst_counter|cnt\(0) & (\inst_counter|cnt\(2) & (\inst_counter|cnt\(3) & \inst_counter|cnt\(1))))
